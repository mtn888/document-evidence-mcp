...
- 旧版 Word `.doc` 支持已于 2026-08-18 提交、部署并推送到 `origin/main`；生产 clone 的既有未提交修改已保留且未推送。
...
|---|---|---|---|---|---|
| 01a00fd3-47c5-76a0-a7a7-e71ae3dda6a1 | 已完成 | src/document_evidence_mcp; tests; README.md; docs/architecture.zh-CN.md; .env.example; .codex; D:/Codexhome/document-evidence-mcp; D:/Codexhome/document-evidence-mcp-runtime | 2026-08-18T00:45:00+08:00 | 9199ee93e22f50702013660ace728c6dec9ee7c4 | 增加 `.doc` 路由、禁用宏的 Word COM 转换、可操作诊断与 300 秒可配置超时。 |
